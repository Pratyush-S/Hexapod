...
int y=0;
int pos;
int buttonPin_1 = 3; int buttonPin_2= 4;//SW of controller 1&2 respectively
int buttonState_1 =0;
int buttonState_2= 0;
void setup() {
  Serial.begin(9600);
...
void loop() {
 ...
 val = analogRead(0);//x of controller 1
   ...
   x = analogRead(2);//x of controller 2
    y = analogRead(4);//y of controller 2
...
// Serial.println(buttonState_1); 
 ...
 if((buttonState_1 == 0) && (buttonState_2 == 0))
  ...
  else if((buttonState_1 == 1) && (buttonState_2 == 1) && (x==526) && (y>=522))
  {
  ...
  pos=6; 
    ...
    else if((x==526) && (y>522) &&(y<=1023)&& (val==517) && (val2==505))
    {
  Serial.println("right_2"); 
  pos=8;
    delay(500);
    }
   else if((x>=0)&& (x<526) && (y==522)&& (val==517) && (val2==505))
    {
  Serial.println("down_2"); 
  pos=7;
    delay(500);
    }
    else if((x>=526)&& (y>=0) && (y<522))
    {
